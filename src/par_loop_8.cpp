...
#pragma omp parallel num_threads( thread_count ) 
        {
#pragma omp for nowait schedule (static)
                for (long long int pixel_number = 0; pixel_number < total_pixels; pixel_number+=8 ) {
                        ...
                        final_image[pixel_number+4] = (int )( acumulado[ initial_image[pixel_number+4]] );
                        final_image[pixel_number+5] = (int )( acumulado[ initial_image[pixel_number+5]] );
                        final_image[pixel_number+6] = (int )( acumulado[ initial_image[pixel_number+6]] );
                        final_image[pixel_number+7] = (int )( acumulado[ initial_image[pixel_number+7]] );
                }
        } 
}
